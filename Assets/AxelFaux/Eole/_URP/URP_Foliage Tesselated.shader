	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_output_331_0_g3713 = (half3(0,0,1)).xz;
				float3 worldToObjDir141_g3671 = normalize( mul( GetWorldToObjectMatrix(), float4( WindDirection, 0 ) ).xyz );
				float3 wpo_wind_direction306_g3712 = worldToObjDir141_g3671;
				float3 temp_output_295_0_g3713 = wpo_wind_direction306_g3712;
				float dotResult330_g3713 = dot( temp_output_331_0_g3713 , (temp_output_295_0_g3713).xz );
				float3 break444_g3713 = temp_output_295_0_g3713;
				float2 appendResult355_g3713 = (float2(break444_g3713.z , break444_g3713.x));
				float dotResult356_g3713 = dot( temp_output_331_0_g3713 , appendResult355_g3713 );
				float3 objToWorld183_g3671 = mul( GetObjectToWorldMatrix(), float4( v.positionOS.xyz, 1 ) ).xyz;
				...
				float mulTime137_g3671 = _TimeParameters.x * ( WindOffsetSpeed / 10.0 );
				...
				float wpo_wind_rawMask497_g3712 = temp_output_2375_0;
				float debug_disableWPO486_g3712 = DebugDisableWPO;
				#ifdef _DEBUGDISABLEWINDDPO_ON
				float staticSwitch479_g3712 = ( debug_disableWPO486_g3712 == 1.0 ? 0.0 : wpo_wind_rawMask497_g3712 );
				#else
				float staticSwitch479_g3712 = wpo_wind_rawMask497_g3712;
				#endif
				float wpo_wind_mask302_g3712 = staticSwitch479_g3712;
				float wind_mask423_g3713 = wpo_wind_mask302_g3712;
				float lerpResult192_g3713 = lerp( 0.0 , ( acos( dotResult330_g3713 ) * sign( dotResult356_g3713 ) ) , wind_mask423_g3713);
				float3 appendResult465_g3713 = (float3(0.0 , _BezierP1.y , _BezierP1.x));
				float3 temp_output_453_0_g3713 = ( appendResult465_g3713 * _BezierAlpha );
				float3 appendResult419_g3713 = (float3(0.0 , _BezierOffsetP1.y , _BezierOffsetP1.x));
				float3 rotatedValue187_g3713 = RotateAroundAxis( float3( 0,0,0 ), ( temp_output_453_0_g3713 + ( appendResult419_g3713 * wind_mask423_g3713 * _BezierOffsetAlpha ) ), float3( 0,1,0 ), lerpResult192_g3713 );
				float3 temp_output_15_0_g3714 = rotatedValue187_g3713;
				float3 p121_g3714 = temp_output_15_0_g3714;
				float3 appendResult463_g3713 = (float3(0.0 , _BezierP2.y , _BezierP2.x));
				float3 temp_output_454_0_g3713 = ( appendResult463_g3713 * _BezierAlpha );
				float3 appendResult420_g3713 = (float3(0.0 , _BezierOffsetP2.y , _BezierOffsetP2.x));
				float3 rotatedValue195_g3713 = RotateAroundAxis( float3( 0,0,0 ), ( temp_output_454_0_g3713 + ( appendResult420_g3713 * wind_mask423_g3713 * _BezierOffsetAlpha ) ), float3( 0,1,0 ), lerpResult192_g3713 );
				float3 temp_output_14_0_g3714 = rotatedValue195_g3713;
				float3 p221_g3714 = temp_output_14_0_g3714;
				float wpo_CoordMask184_g3712 = v.ase_color.r;
				float temp_output_6_0_g3714 = wpo_CoordMask184_g3712;
				float t21_g3714 = temp_output_6_0_g3714;
				float3 localTrigonometricBezierCurve21_g3714 = TrigonometricBezierCurve( p121_g3714 , p221_g3714 , t21_g3714 );
				float3 temp_output_500_0_g3712 = localTrigonometricBezierCurve21_g3714;
				half3 _RelativeUp = half3(0,1,0);
				float3 temp_output_26_0_g3715 = wpo_wind_direction306_g3712;
				float dotResult7_g3715 = dot( temp_output_26_0_g3715 , _RelativeUp );
				float lerpResult10_g3715 = lerp( -1.570796 , 1.570796 , ( ( dotResult7_g3715 * 0.5 ) + 0.5 ));
				float3 rotatedValue17_g3715 = RotateAroundAxis( float3( 0,0,0 ), temp_output_26_0_g3715, normalize( cross( _RelativeUp , temp_output_26_0_g3715 ) ), lerpResult10_g3715 );
				float temp_output_25_0_g3715 = wpo_wind_mask302_g3712;
				float lerpResult21_g3715 = lerp( 0.0 , _SimpleWindyYOffset , temp_output_25_0_g3715);
				float3 appendResult23_g3715 = (float3(0.0 , lerpResult21_g3715 , 0.0));
				float3 temp_output_499_0_g3712 = ( wpo_CoordMask184_g3712 * ( ( rotatedValue17_g3715 + appendResult23_g3715 ) * _SimpleWindDisplacement * temp_output_25_0_g3715 ) );
				#if defined(_WIND_NONE)
				float3 staticSwitch166_g3712 = float3( 0,0,0 );
				#elif defined(_WIND_SIMPLE)
				float3 staticSwitch166_g3712 = temp_output_499_0_g3712;
				#elif defined(_WIND_ADVANCED)
				float3 staticSwitch166_g3712 = temp_output_500_0_g3712;
				#else
				float3 staticSwitch166_g3712 = temp_output_500_0_g3712;
				#endif
				float3 out_wpo_windy423_g3712 = staticSwitch166_g3712;
				float3 temp_output_159_0_g3719 = out_wpo_windy423_g3712;
				float4 transform584_g3712 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float4 tex2DNode29_g3719 = tex2Dlod( CrushRenderTexture, float4( ( ( ( (transform584_g3712).xz + -CrushBufferOffset ) + ( CrushBufferSize / 2.0 ) ) / CrushBufferSize ), 0, 0.0) );
				float2 temp_output_96_0_g3719 = ( ( (tex2DNode29_g3719).rg - float2( 0.5,0.5 ) ) * float2( 2,2 ) );
				float2 break98_g3719 = temp_output_96_0_g3719;
				float3 appendResult102_g3719 = (float3(break98_g3719.x , 0.0 , break98_g3719.y));
				float3 worldToObjDir101_g3719 = mul( GetWorldToObjectMatrix(), float4( appendResult102_g3719, 0 ) ).xyz;
				float3 crush_direction172_g3719 = worldToObjDir101_g3719;
				float vectorField_length134_g3719 = length( temp_output_96_0_g3719 );
				float3 temp_output_126_0_g3719 = float3( 0,0,0 );
				float3 ase_worldPos = TransformObjectToWorld( (v.positionOS).xyz );
				float3 worldToObj14_g3719 = mul( GetWorldToObjectMatrix(), float4( ase_worldPos, 1 ) ).xyz;
				float3 rotatedValue16_g3719 = RotateAroundAxis( temp_output_126_0_g3719, worldToObj14_g3719, crush_direction172_g3719, ( radians( _CrushAngle ) * vectorField_length134_g3719 ) );
				float3 appendResult195_g3719 = (float3(1.0 , ( 1.0 - _CrushFlattenScale ) , 1.0));
				float3 appendResult66_g3719 = (float3(0.0 , _CrushHeightOffset , 0.0));
				float crush_coordMasd87_g3719 = wpo_CoordMask184_g3712;
				float3 ase_parentObjectScale = ( 1.0 / float3( length( GetWorldToObjectMatrix()[ 0 ].xyz ), length( GetWorldToObjectMatrix()[ 1 ].xyz ), length( GetWorldToObjectMatrix()[ 2 ].xyz ) ) );
				float RT_b236_g3719 = tex2DNode29_g3719.b;
				float4 transform223_g3719 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float temp_output_235_0_g3719 = ( RT_b236_g3719 == 0.0 ? ( ( vectorField_length134_g3719 * saturate( ( crush_coordMasd87_g3719 * 8.0 ) ) ) * saturate( ( ( CrushDistanceView - distance( float4( _WorldSpaceCameraPos , 0.0 ) , transform223_g3719 ) ) / CrushDistanceViewFalloff ) ) ) : 0.0 );
				float3 lerpResult160_g3719 = lerp( temp_output_159_0_g3719 , ( ( ( rotatedValue16_g3719 - worldToObj14_g3719 ) * appendResult195_g3719 ) + ( appendResult66_g3719 * crush_coordMasd87_g3719 * ase_parentObjectScale.y ) ) , temp_output_235_0_g3719);
				#ifdef _USECRUSH_ON
				float3 staticSwitch162_g3719 = lerpResult160_g3719;
				#else
				float3 staticSwitch162_g3719 = temp_output_159_0_g3719;
				#endif
				float3 out_wpo_crush432_g3712 = staticSwitch162_g3719;
				float smoothstepResult112_g3716 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g3712);
				float temp_output_153_0_g3716 = saturate( smoothstepResult112_g3716 );
				float4 transform119_g3716 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float mulTime95_g3716 = _TimeParameters.x * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float temp_output_99_0_g3716 = ( cos( ( ( ( ( ( transform119_g3716.x * 100.0 ) + ( transform119_g3716.z * 33.0 ) ) - mulTime95_g3716 ) + v.positionOS.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * v.texcoord.y );
				float3 temp_output_88_0_g3716 = wpo_wind_direction306_g3712;
				float3 temp_output_544_0_g3712 = ( out_wpo_crush432_g3712 + ( temp_output_153_0_g3716 * temp_output_99_0_g3716 * temp_output_88_0_g3716 ) );
				#if defined(_WIND_NONE)
				float3 staticSwitch438_g3712 = float3( 0,0,0 );
				#elif defined(_WIND_SIMPLE)
				float3 staticSwitch438_g3712 = temp_output_544_0_g3712;
				#elif defined(_WIND_ADVANCED)
				float3 staticSwitch438_g3712 = temp_output_544_0_g3712;
				#else
				float3 staticSwitch438_g3712 = temp_output_544_0_g3712;
				#endif
				float3 wpo_out_turbulence508_g3712 = staticSwitch438_g3712;
				#ifdef _DEBUGDISABLEWINDDPO_ON
				float3 staticSwitch466_g3712 = ( debug_disableWPO486_g3712 == 1.0 ? out_wpo_crush432_g3712 : wpo_out_turbulence508_g3712 );
				#else
				float3 staticSwitch466_g3712 = wpo_out_turbulence508_g3712;
				#endif
				
				float3 lerpResult3_g3670 = lerp( v.normalOS , float3(0,1,0) , _FlattenVertexNormal);
				...
				float3 vertexValue = staticSwitch466_g3712;
						 ...
						 ) : SV_Target
			{
				...
				float3 objToWorld183_g3671 = mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord9.xyz, 1 ) ).xyz;
				float3 break153_g3671 = -objToWorld183_g3671;
				float2 appendResult155_g3671 = (float2(break153_g3671.x , break153_g3671.z));
				float2 _wind_UVs106_g3671 = appendResult155_g3671;
				float mulTime137_g3671 = _TimeParameters.x * ( WindOffsetSpeed / 10.0 );
				...
				float4 transform584_g3712 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float4 tex2DNode29_g3719 = tex2D( CrushRenderTexture, ( ( ( (transform584_g3712).xz + -CrushBufferOffset ) + ( CrushBufferSize / 2.0 ) ) / CrushBufferSize ) );
				float RT_b236_g3719 = tex2DNode29_g3719.b;
				float2 temp_output_96_0_g3719 = ( ( (tex2DNode29_g3719).rg - float2( 0.5,0.5 ) ) * float2( 2,2 ) );
				float vectorField_length134_g3719 = length( temp_output_96_0_g3719 );
				float wpo_CoordMask184_g3712 = IN.ase_color.r;
				float crush_coordMasd87_g3719 = wpo_CoordMask184_g3712;
				float4 transform223_g3719 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float temp_output_235_0_g3719 = ( RT_b236_g3719 == 0.0 ? ( ( vectorField_length134_g3719 * saturate( ( crush_coordMasd87_g3719 * 8.0 ) ) ) * saturate( ( ( CrushDistanceView - distance( float4( _WorldSpaceCameraPos , 0.0 ) , transform223_g3719 ) ) / CrushDistanceViewFalloff ) ) ) : 0.0 );
				#ifdef _USECRUSH_ON
				float staticSwitch163_g3719 = temp_output_235_0_g3719;
				#else
				float staticSwitch163_g3719 = 0.0;
				#endif
				float lerpResult78_g3665 = lerp( lerpResult71_g3665 , _CrushBrightness , staticSwitch163_g3719);
				...
				float mulTime95_g3716 = _TimeParameters.x * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float temp_output_99_0_g3716 = ( cos( ( ( ( ( ( transform119_g3716.x * 100.0 ) + ( transform119_g3716.z * 33.0 ) ) - mulTime95_g3716 ) + IN.ase_texcoord9.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * IN.ase_texcoord8.xy.y );
				float wpo_wind_rawMask497_g3712 = temp_output_2375_0;
				float smoothstepResult112_g3716 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g3712);
				float temp_output_153_0_g3716 = saturate( smoothstepResult112_g3716 );
				float temp_output_544_85_g3712 = ( temp_output_99_0_g3716 * temp_output_153_0_g3716 );
				#if defined(_WIND_NONE)
				float staticSwitch441_g3712 = 0.0;
				#elif defined(_WIND_SIMPLE)
				float staticSwitch441_g3712 = temp_output_544_85_g3712;
				#elif defined(_WIND_ADVANCED)
				float staticSwitch441_g3712 = temp_output_544_85_g3712;
				#else
				float staticSwitch441_g3712 = temp_output_544_85_g3712;
				#endif
				float4 lerpResult62_g3669 = lerp( ifLocalVar131_g3669 , color64_g3669 , ( (float)debugWindTurbulence103_g3669 == 1.0 ? saturate( ( staticSwitch441_g3712 * 20.0 ) ) : 0.0 ));
				#ifdef _DEBUGWIND_ON
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float mulTime95_g3716 = _TimeParameters.x * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float temp_output_99_0_g3716 = ( cos( ( ( ( ( ( transform119_g3716.x * 100.0 ) + ( transform119_g3716.z * 33.0 ) ) - mulTime95_g3716 ) + v.positionOS.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * v.ase_texcoord.y );
				float3 temp_output_88_0_g3716 = wpo_wind_direction306_g3712;
				float3 temp_output_544_0_g3712 = ( out_wpo_crush432_g3712 + ( temp_output_153_0_g3716 * temp_output_99_0_g3716 * temp_output_88_0_g3716 ) );
				#if defined(_WIND_NONE)
				float3 staticSwitch438_g3712 = float3( 0,0,0 );
						 ...
						 ) : SV_TARGET
			{
				...
				#endif
				float4 temp_output_23_0_g3665 = staticSwitch128_g3662;
				float3 objToWorld183_g3671 = mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord4.xyz, 1 ) ).xyz;
				float3 break153_g3671 = -objToWorld183_g3671;
				float2 appendResult155_g3671 = (float2(break153_g3671.x , break153_g3671.z));
				float2 _wind_UVs106_g3671 = appendResult155_g3671;
				float mulTime137_g3671 = _TimeParameters.x * ( WindOffsetSpeed / 10.0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float mulTime95_g3716 = _TimeParameters.x * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float temp_output_99_0_g3716 = ( cos( ( ( ( ( ( transform119_g3716.x * 100.0 ) + ( transform119_g3716.z * 33.0 ) ) - mulTime95_g3716 ) + v.positionOS.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * v.texcoord0.y );
				float3 temp_output_88_0_g3716 = wpo_wind_direction306_g3712;
				float3 temp_output_544_0_g3712 = ( out_wpo_crush432_g3712 + ( temp_output_153_0_g3716 * temp_output_99_0_g3716 * temp_output_88_0_g3716 ) );
				#if defined(_WIND_NONE)
				float3 staticSwitch438_g3712 = float3( 0,0,0 );
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				#endif
				float4 temp_output_23_0_g3665 = staticSwitch128_g3662;
				float3 objToWorld183_g3671 = mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord5.xyz, 1 ) ).xyz;
				float3 break153_g3671 = -objToWorld183_g3671;
				float2 appendResult155_g3671 = (float2(break153_g3671.x , break153_g3671.z));
				float2 _wind_UVs106_g3671 = appendResult155_g3671;
				float mulTime137_g3671 = _TimeParameters.x * ( WindOffsetSpeed / 10.0 );
				...
				float mulTime95_g3716 = _TimeParameters.x * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float temp_output_99_0_g3716 = ( cos( ( ( ( ( ( transform119_g3716.x * 100.0 ) + ( transform119_g3716.z * 33.0 ) ) - mulTime95_g3716 ) + IN.ase_texcoord5.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * IN.ase_texcoord4.xy.y );
				float wpo_wind_rawMask497_g3712 = temp_output_2375_0;
				float smoothstepResult112_g3716 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g3712);
				float temp_output_153_0_g3716 = saturate( smoothstepResult112_g3716 );
				float temp_output_544_85_g3712 = ( temp_output_99_0_g3716 * temp_output_153_0_g3716 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				#endif
				float4 temp_output_23_0_g3665 = staticSwitch128_g3662;
				float3 objToWorld183_g3671 = mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord3.xyz, 1 ) ).xyz;
				float3 break153_g3671 = -objToWorld183_g3671;
				float2 appendResult155_g3671 = (float2(break153_g3671.x , break153_g3671.z));
				float2 _wind_UVs106_g3671 = appendResult155_g3671;
				float mulTime137_g3671 = _TimeParameters.x * ( WindOffsetSpeed / 10.0 );
				...
				float mulTime95_g3716 = _TimeParameters.x * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float temp_output_99_0_g3716 = ( cos( ( ( ( ( ( transform119_g3716.x * 100.0 ) + ( transform119_g3716.z * 33.0 ) ) - mulTime95_g3716 ) + IN.ase_texcoord3.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * IN.ase_texcoord2.xy.y );
				float wpo_wind_rawMask497_g3712 = temp_output_2375_0;
				float smoothstepResult112_g3716 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g3712);
				float temp_output_153_0_g3716 = saturate( smoothstepResult112_g3716 );
				float temp_output_544_85_g3712 = ( temp_output_99_0_g3716 * temp_output_153_0_g3716 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				#endif
				float4 temp_output_23_0_g3665 = staticSwitch128_g3662;
				float3 objToWorld183_g3671 = mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord6.xyz, 1 ) ).xyz;
				float3 break153_g3671 = -objToWorld183_g3671;
				float2 appendResult155_g3671 = (float2(break153_g3671.x , break153_g3671.z));
				float2 _wind_UVs106_g3671 = appendResult155_g3671;
				float mulTime137_g3671 = _TimeParameters.x * ( WindOffsetSpeed / 10.0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				#endif
				float4 temp_output_23_0_g3665 = staticSwitch128_g3662;
				float3 objToWorld183_g3671 = mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord2.xyz, 1 ) ).xyz;
				float3 break153_g3671 = -objToWorld183_g3671;
				float2 appendResult155_g3671 = (float2(break153_g3671.x , break153_g3671.z));
				float2 _wind_UVs106_g3671 = appendResult155_g3671;
				float mulTime137_g3671 = _TimeParameters.x * ( WindOffsetSpeed / 10.0 );
...
Node;AmplifyShaderEditor.FunctionNode;2432;-1872,-80;Inherit;False;Foliage Vertex Offset;37;;3712;0fe3090401650924eb84218df3d02dc9;8,177,2,28,3,435,3,437,3,507,0,117,1,65,1,583,0;3;421;FLOAT;0;False;422;FLOAT3;0,0,0;False;176;FLOAT;1;False;3;FLOAT3;0;FLOAT;61;FLOAT;109
...
WireConnection;1;8;2432;0
WireConnection;1;10;2426;0
WireConnection;2423;457;2375;0
WireConnection;2423;480;2375;139
WireConnection;2423;466;2432;61
WireConnection;2423;161;2432;109
WireConnection;2432;421;2375;0
WireConnection;2432;422;2375;24
ASEEND*/
//CHKSM=D76B29FF02DF7369783846C87079EF7E4DAB1190