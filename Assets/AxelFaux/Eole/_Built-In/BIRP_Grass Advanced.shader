...
Shader "Eole/Built-In/Grass Advanced"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
			...
			float CheapContrast1_g3719( float In, float Value )
			{
				float A = 0 - Value;
				float B = 1 + Value;
			...
			float CheapContrast1_g3721( float In, float Value )
			{
				float A = 0 - Value;
				float B = 1 + Value;
				return clamp(0,1, lerp(A,B,In));
			...
			float2 RotateUV67_g3725( float2 UV, float Angle )
			{
				// Rotation Matrix
			...
			v2f VertexFunction (appdata v  ) {
				...
				float3 worldToObjDir141_g3678 = normalize( mul( unity_WorldToObject, float4( WindDirection, 0 ) ).xyz );
				float3 wpo_wind_direction306_g3679 = worldToObjDir141_g3678;
				...
				float3 objToWorld183_g3678 = mul( unity_ObjectToWorld, float4( v.vertex.xyz, 1 ) ).xyz;
				float3 break153_g3678 = -objToWorld183_g3678;
				float2 appendResult155_g3678 = (float2(break153_g3678.x , break153_g3678.z));
				float2 _wind_UVs106_g3678 = appendResult155_g3678;
				float mulTime137_g3678 = _Time.y * ( WindOffsetSpeed / 10.0 );
				float3 break187_g3678 = WindDirection;
				float2 appendResult188_g3678 = (float2(break187_g3678.x , break187_g3678.z));
				float2 _wind_direction110_g3678 = appendResult188_g3678;
				float4 tex2DNode144_g3678 = tex2Dlod( WindMap, float4( ( ( _wind_UVs106_g3678 / WindTillingSize ) + ( mulTime137_g3678 * _wind_direction110_g3678 ) ), 0, 0.0) );
				float smoothstepResult53_g3678 = smoothstep( WindSmoothstep.x , WindSmoothstep.y , tex2DNode144_g3678.r);
				float smoothstepResult170_g3678 = smoothstep( _SecondWindSmoothstep.x , _SecondWindSmoothstep.y , smoothstepResult53_g3678);
				float _wind_amplitude116_g3678 = WindAmplitude;
				float temp_output_2479_0 = ( smoothstepResult170_g3678 * _wind_amplitude116_g3678 );
				float wpo_wind_rawMask497_g3679 = temp_output_2479_0;
				...
				float3 lerpResult3_g3697 = lerp( v.normal , float3(0,1,0) , _FlattenVertexNormal);
				...
				) : SV_Target
			{
				...
				float3 ase_parentObjectScale = ( 1.0 / float3( length( unity_WorldToObject[ 0 ].xyz ), length( unity_WorldToObject[ 1 ].xyz ), length( unity_WorldToObject[ 2 ].xyz ) ) );
				float In1_g3719 = ( ase_parentObjectScale.y + _VariantOffset );
				float Value1_g3719 = _VariantContrast;
				float localCheapContrast1_g3719 = CheapContrast1_g3719( In1_g3719 , Value1_g3719 );
				float4 lerpResult350_g3718 = lerp( _MainBaseColor , _VariantBaseColor , saturate( localCheapContrast1_g3719 ));
				float4 appendResult442_g3718 = (float4((lerpResult350_g3718).rgb , 1.0));
				float2 uv_BaseMap53_g3718 = IN.ase_texcoord9.xy;
				float4 tex2DNode53_g3718 = tex2D( _BaseMap, uv_BaseMap53_g3718 );
				float4 _baseMap50_g3718 = tex2DNode53_g3718;
				float4 temp_output_428_0_g3718 = ( appendResult442_g3718 * _baseMap50_g3718 );
				float4 temp_output_124_0_g3720 = temp_output_428_0_g3718;
				float3 temp_output_125_0_g3720 = (temp_output_124_0_g3720).rgb;
				float _colormap_baseMap_Alpha146_g3720 = (temp_output_124_0_g3720).a;
				float4 appendResult132_g3720 = (float4(temp_output_125_0_g3720 , _colormap_baseMap_Alpha146_g3720));
				float coord_mask88_g3718 = IN.ase_color.r;
				float In1_g3721 = ( coord_mask88_g3718 - _ColorMapBlendOffset );
				float Value1_g3721 = _ColorMapFadeContrast;
				float localCheapContrast1_g3721 = CheapContrast1_g3721( In1_g3721 , Value1_g3721 );
				float3 lerpResult97_g3720 = lerp( (tex2D( ColorMap, ( ( (worldPos).xz + ColorMapOffset ) / ColorMapTillingSize ) )).rgb , temp_output_125_0_g3720 , saturate( ( (lerpResult350_g3718).a * localCheapContrast1_g3721 ) ));
				float3 break65_g3720 = lerpResult97_g3720;
				float4 appendResult64_g3720 = (float4(break65_g3720.x , break65_g3720.y , break65_g3720.z , _colormap_baseMap_Alpha146_g3720));
				#ifdef _USECOLORMAP_ON
				float4 staticSwitch128_g3720 = appendResult64_g3720;
				#else
				float4 staticSwitch128_g3720 = appendResult132_g3720;
				#endif
				float4 temp_output_23_0_g3723 = staticSwitch128_g3720;
				float3 objToWorld183_g3678 = mul( unity_ObjectToWorld, float4( IN.ase_texcoord10.xyz, 1 ) ).xyz;
				float3 break153_g3678 = -objToWorld183_g3678;
				float2 appendResult155_g3678 = (float2(break153_g3678.x , break153_g3678.z));
				float2 _wind_UVs106_g3678 = appendResult155_g3678;
				float mulTime137_g3678 = _Time.y * ( WindOffsetSpeed / 10.0 );
				...
				float2 appendResult188_g3678 = (float2(break187_g3678.x , break187_g3678.z));
				float2 _wind_direction110_g3678 = appendResult188_g3678;
				float4 tex2DNode144_g3678 = tex2D( WindMap, ( ( _wind_UVs106_g3678 / WindTillingSize ) + ( mulTime137_g3678 * _wind_direction110_g3678 ) ) );
				float smoothstepResult53_g3678 = smoothstep( WindSmoothstep.x , WindSmoothstep.y , tex2DNode144_g3678.r);
				float smoothstepResult170_g3678 = smoothstep( _SecondWindSmoothstep.x , _SecondWindSmoothstep.y , smoothstepResult53_g3678);
				float _wind_amplitude116_g3678 = WindAmplitude;
				float temp_output_2479_0 = ( smoothstepResult170_g3678 * _wind_amplitude116_g3678 );
				float windMask397_g3718 = temp_output_2479_0;
				float lerpResult71_g3723 = lerp( 1.0 , _WindBrightness , windMask397_g3718);
				float4 transform584_g3679 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				...
				#endif
				float lerpResult78_g3723 = lerp( lerpResult71_g3723 , _CrushBrightness , staticSwitch163_g3686);
				float lerpResult83_g3723 = lerp( 1.0 , lerpResult78_g3723 , saturate( ( coord_mask88_g3718 * 2.0 ) ));
				float4 appendResult29_g3723 = (float4((saturate( ( temp_output_23_0_g3723 * lerpResult83_g3723 ) )).rgb , (temp_output_23_0_g3723).a));
				float4 temp_output_529_0_g3718 = appendResult29_g3723;
				float4 _translucency_inColor32_g3726 = temp_output_529_0_g3718;
				...
				float3 blendOpSrc15_g3726 = temp_cast_3;
				float3 blendOpDest15_g3726 = (_translucency_inColor32_g3726).rgb;
				float3 normalizeResult19_g3726 = normalize( ( _WorldSpaceCameraPos - worldPos ) );
				float3 worldSpaceLightDir = UnityWorldSpaceLightDir(worldPos);
				float dotResult20_g3726 = dot( normalizeResult19_g3726 , -worldSpaceLightDir );
				float saferPower25_g3726 = abs( ( ( dotResult20_g3726 + 1.0 ) / 2.0 ) );
				float lerpResult3_g3726 = lerp( _TranslucencyShadows , _TranslucencyDirect , float4(atten,0,0,0));
				float3 lerpBlendMode15_g3726 = lerp(blendOpDest15_g3726,2.0f*blendOpDest15_g3726*blendOpSrc15_g3726 + blendOpDest15_g3726*blendOpDest15_g3726*(1.0f - 2.0f*blendOpSrc15_g3726),( saturate( pow( saferPower25_g3726 , _TranslucencyDotViewPower ) ) * lerpResult3_g3726 ));
				float4 appendResult30_g3726 = (float4(( saturate( lerpBlendMode15_g3726 )) , (_translucency_inColor32_g3726).a));
				#ifdef _USETRANSLUCENCY_ON
				float4 staticSwitch31_g3726 = appendResult30_g3726;
				#else
				float4 staticSwitch31_g3726 = _translucency_inColor32_g3726;
				#endif
				float4 temp_output_72_0_g3725 = staticSwitch31_g3726;
				float2 temp_output_5_0_g3725 = (worldPos).xz;
				float mulTime8_g3725 = _Time.y * -( WindOffsetSpeed * AirSpeedMultiplier );
				float2 UV67_g3725 = ( temp_output_5_0_g3725 + ( mulTime8_g3725 * (WindDirection).xz ) );
				float windAngle482_g3718 = WindAngle;
				float Angle67_g3725 = windAngle482_g3718;
				float2 localRotateUV67_g3725 = RotateUV67_g3725( UV67_g3725 , Angle67_g3725 );
				float smoothstepResult23_g3725 = smoothstep( AirSmoothstep.x , AirSmoothstep.y , tex2D( AirMap, ( (UnpackScaleNormal( tex2D( AirRefractionMap, ( temp_output_5_0_g3725 / AirRefractionTillingSize ) ), AirRefractionStrength )).xy + ( localRotateUV67_g3725 / AirTillingSize ) ) ).r);
				#ifdef _USEAIRSHEENTINT_ON
				float4 staticSwitch73_g3725 = saturate( ( temp_output_72_0_g3725 + ( smoothstepResult23_g3725 * AirStrength * saturate( ( IN.ase_color.r * 4.0 ) ) * windMask397_g3718 ) ) );
				#else
				float4 staticSwitch73_g3725 = temp_output_72_0_g3725;
				#endif
				float4 albedo109_g3727 = staticSwitch73_g3725;
				int isDebugWind98_g3727 = ( DebugWind + DebugWindTurbulence );
				int debugWindTurbulence103_g3727 = DebugWindTurbulence;
				int debugWind105_g3727 = DebugWind;
				half4 color126_g3727 = IsGammaSpace() ? half4(0,0,0,0) : half4(0,0,0,0);
				Gradient gradient82_g3727 = NewGradient( 0, 7, 2, float4( 0.5, 0.5, 0.5, 0 ), float4( 0, 0.716, 0, 0.06471352 ), float4( 1, 1, 0, 0.2205844 ), float4( 1, 0.5698085, 0, 0.5470665 ), float4( 1, 0.3047979, 0, 0.7499962 ), float4( 1, 0, 0, 0.9411765 ), float4( 0.5626073, 0, 1, 1 ), 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float4 temp_output_106_0_g3727 = ( (float)debugWind105_g3727 == 1.0 ? SampleGradient( gradient82_g3727, windMask397_g3718 ) : albedo109_g3727 );
				float4 ifLocalVar131_g3727 = 0;
				if( debugWindTurbulence103_g3727 <= debugWind105_g3727 )
				ifLocalVar131_g3727 = temp_output_106_0_g3727;
				else
				ifLocalVar131_g3727 = color126_g3727;
				half4 color64_g3727 = IsGammaSpace() ? half4(1,1,1,0) : half4(1,1,1,0);
				float4 transform119_g3683 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				float mulTime95_g3683 = _Time.y * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float temp_output_99_0_g3683 = ( cos( ( ( ( ( ( transform119_g3683.x * 100.0 ) + ( transform119_g3683.z * 33.0 ) ) - mulTime95_g3683 ) + IN.ase_texcoord10.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * IN.ase_texcoord9.xy.y );
				float wpo_wind_rawMask497_g3679 = temp_output_2479_0;
				float smoothstepResult112_g3683 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g3679);
				float temp_output_153_0_g3683 = saturate( smoothstepResult112_g3683 );
				...
				float staticSwitch441_g3679 = temp_output_544_85_g3679;
				#endif
				float4 lerpResult62_g3727 = lerp( ifLocalVar131_g3727 , color64_g3727 , ( (float)debugWindTurbulence103_g3727 == 1.0 ? saturate( ( staticSwitch441_g3679 * 20.0 ) ) : 0.0 ));
				#ifdef _DEBUGWIND_ON
				float4 staticSwitch134_g3727 = ( (float)isDebugWind98_g3727 >= 1.0 ? lerpResult62_g3727 : albedo109_g3727 );
				#else
				float4 staticSwitch134_g3727 = albedo109_g3727;
				#endif
				
				float2 uv_NormalMap71_g3718 = IN.ase_texcoord9.xy;
				float3 lerpResult417_g3718 = lerp( half3(0,0,1) , UnpackScaleNormal( tex2D( _NormalMap, uv_NormalMap71_g3718 ), _NormalStrength ) , saturate( ( coord_mask88_g3718 * 3.0 ) ));
				
				o.Albedo = (staticSwitch134_g3727).xyz;
				o.Normal = lerpResult417_g3718;
				...
				o.Smoothness = 0.0;
				o.Occlusion = 1;
				o.Alpha = (temp_output_529_0_g3718).a;
		...
		Pass
		{
			...
			)
			{
				...
				float4 lerpResult350_g3718 = lerp( _MainBaseColor , _VariantBaseColor , saturate( localCheapContrast1_g3719 ));
				float4 appendResult442_g3718 = (float4((lerpResult350_g3718).rgb , 1.0));
				float2 uv_BaseMap53_g3718 = IN.ase_texcoord8.xy;
				float4 tex2DNode53_g3718 = tex2D( _BaseMap, uv_BaseMap53_g3718 );
				float4 _baseMap50_g3718 = tex2DNode53_g3718;
				float4 temp_output_428_0_g3718 = ( appendResult442_g3718 * _baseMap50_g3718 );
				float4 temp_output_124_0_g3720 = temp_output_428_0_g3718;
				...
				#endif
				float4 temp_output_23_0_g3723 = staticSwitch128_g3720;
				float3 objToWorld183_g3678 = mul( unity_ObjectToWorld, float4( IN.ase_texcoord9.xyz, 1 ) ).xyz;
				float3 break153_g3678 = -objToWorld183_g3678;
				float2 appendResult155_g3678 = (float2(break153_g3678.x , break153_g3678.z));
				float2 _wind_UVs106_g3678 = appendResult155_g3678;
				float mulTime137_g3678 = _Time.y * ( WindOffsetSpeed / 10.0 );
				...
				float mulTime95_g3683 = _Time.y * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float temp_output_99_0_g3683 = ( cos( ( ( ( ( ( transform119_g3683.x * 100.0 ) + ( transform119_g3683.z * 33.0 ) ) - mulTime95_g3683 ) + IN.ase_texcoord9.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * IN.ase_texcoord8.xy.y );
				float wpo_wind_rawMask497_g3679 = temp_output_2479_0;
				float smoothstepResult112_g3683 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g3679);
				float temp_output_153_0_g3683 = saturate( smoothstepResult112_g3683 );
				float temp_output_544_85_g3679 = ( temp_output_99_0_g3683 * temp_output_153_0_g3683 );
				...
				float2 uv_NormalMap71_g3718 = IN.ase_texcoord8.xy;
				float3 lerpResult417_g3718 = lerp( half3(0,0,1) , UnpackScaleNormal( tex2D( _NormalMap, uv_NormalMap71_g3718 ), _NormalStrength ) , saturate( ( coord_mask88_g3718 * 3.0 ) ));
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float4 lerpResult350_g3718 = lerp( _MainBaseColor , _VariantBaseColor , saturate( localCheapContrast1_g3719 ));
				float4 appendResult442_g3718 = (float4((lerpResult350_g3718).rgb , 1.0));
				float2 uv_BaseMap53_g3718 = IN.ase_texcoord3.xy;
				float4 tex2DNode53_g3718 = tex2D( _BaseMap, uv_BaseMap53_g3718 );
				float4 _baseMap50_g3718 = tex2DNode53_g3718;
				float4 temp_output_428_0_g3718 = ( appendResult442_g3718 * _baseMap50_g3718 );
				float4 temp_output_124_0_g3720 = temp_output_428_0_g3718;
				...
				float Value1_g3721 = _ColorMapFadeContrast;
				float localCheapContrast1_g3721 = CheapContrast1_g3721( In1_g3721 , Value1_g3721 );
				float3 lerpResult97_g3720 = lerp( (tex2D( ColorMap, ( ( (ase_worldPos).xz + ColorMapOffset ) / ColorMapTillingSize ) )).rgb , temp_output_125_0_g3720 , saturate( ( (lerpResult350_g3718).a * localCheapContrast1_g3721 ) ));
				float3 break65_g3720 = lerpResult97_g3720;
				float4 appendResult64_g3720 = (float4(break65_g3720.x , break65_g3720.y , break65_g3720.z , _colormap_baseMap_Alpha146_g3720));
				#ifdef _USECOLORMAP_ON
				float4 staticSwitch128_g3720 = appendResult64_g3720;
				...
				#endif
				float4 temp_output_23_0_g3723 = staticSwitch128_g3720;
				float3 objToWorld183_g3678 = mul( unity_ObjectToWorld, float4( IN.ase_texcoord5.xyz, 1 ) ).xyz;
				float3 break153_g3678 = -objToWorld183_g3678;
				float2 appendResult155_g3678 = (float2(break153_g3678.x , break153_g3678.z));
				float2 _wind_UVs106_g3678 = appendResult155_g3678;
				float mulTime137_g3678 = _Time.y * ( WindOffsetSpeed / 10.0 );
				...
				float3 blendOpSrc15_g3726 = temp_cast_3;
				float3 blendOpDest15_g3726 = (_translucency_inColor32_g3726).rgb;
				float3 normalizeResult19_g3726 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
				float3 worldSpaceLightDir = UnityWorldSpaceLightDir(ase_worldPos);
				float dotResult20_g3726 = dot( normalizeResult19_g3726 , -worldSpaceLightDir );
				float saferPower25_g3726 = abs( ( ( dotResult20_g3726 + 1.0 ) / 2.0 ) );
				UNITY_LIGHT_ATTENUATION(ase_atten, IN, ase_worldPos)
				float lerpResult3_g3726 = lerp( _TranslucencyShadows , _TranslucencyDirect , ase_atten);
				float3 lerpBlendMode15_g3726 = lerp(blendOpDest15_g3726,2.0f*blendOpDest15_g3726*blendOpSrc15_g3726 + blendOpDest15_g3726*blendOpDest15_g3726*(1.0f - 2.0f*blendOpSrc15_g3726),( saturate( pow( saferPower25_g3726 , _TranslucencyDotViewPower ) ) * lerpResult3_g3726 ));
				float4 appendResult30_g3726 = (float4(( saturate( lerpBlendMode15_g3726 )) , (_translucency_inColor32_g3726).a));
				#ifdef _USETRANSLUCENCY_ON
				float4 staticSwitch31_g3726 = appendResult30_g3726;
				...
				#endif
				float4 temp_output_72_0_g3725 = staticSwitch31_g3726;
				float2 temp_output_5_0_g3725 = (ase_worldPos).xz;
				float mulTime8_g3725 = _Time.y * -( WindOffsetSpeed * AirSpeedMultiplier );
				float2 UV67_g3725 = ( temp_output_5_0_g3725 + ( mulTime8_g3725 * (WindDirection).xz ) );
				float windAngle482_g3718 = WindAngle;
				float Angle67_g3725 = windAngle482_g3718;
				...
				float mulTime95_g3683 = _Time.y * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float temp_output_99_0_g3683 = ( cos( ( ( ( ( ( transform119_g3683.x * 100.0 ) + ( transform119_g3683.z * 33.0 ) ) - mulTime95_g3683 ) + IN.ase_texcoord5.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * IN.ase_texcoord3.xy.y );
				float wpo_wind_rawMask497_g3679 = temp_output_2479_0;
				float smoothstepResult112_g3683 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g3679);
				float temp_output_153_0_g3683 = saturate( smoothstepResult112_g3683 );
				float temp_output_544_85_g3679 = ( temp_output_99_0_g3683 * temp_output_153_0_g3683 );
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float4 lerpResult350_g3718 = lerp( _MainBaseColor , _VariantBaseColor , saturate( localCheapContrast1_g3719 ));
				float4 appendResult442_g3718 = (float4((lerpResult350_g3718).rgb , 1.0));
				float2 uv_BaseMap53_g3718 = IN.ase_texcoord2.xy;
				float4 tex2DNode53_g3718 = tex2D( _BaseMap, uv_BaseMap53_g3718 );
				float4 _baseMap50_g3718 = tex2DNode53_g3718;
				float4 temp_output_428_0_g3718 = ( appendResult442_g3718 * _baseMap50_g3718 );
				float4 temp_output_124_0_g3720 = temp_output_428_0_g3718;
				...
				#endif
				float4 temp_output_23_0_g3723 = staticSwitch128_g3720;
				float3 objToWorld183_g3678 = mul( unity_ObjectToWorld, float4( IN.ase_texcoord4.xyz, 1 ) ).xyz;
				float3 break153_g3678 = -objToWorld183_g3678;
				float2 appendResult155_g3678 = (float2(break153_g3678.x , break153_g3678.z));
				float2 _wind_UVs106_g3678 = appendResult155_g3678;
				float mulTime137_g3678 = _Time.y * ( WindOffsetSpeed / 10.0 );
