...
Shader "Eole/Built-In/Grass Simple"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
			...
			v2f VertexFunction (appdata v  ) {
				...
				float3 worldToObjDir141_g3670 = normalize( mul( unity_WorldToObject, float4( WindDirection, 0 ) ).xyz );
				float3 wpo_wind_direction306_g2747 = worldToObjDir141_g3670;
				float3 temp_output_26_0_g3646 = wpo_wind_direction306_g2747;
				...
				float3 objToWorld183_g3670 = mul( unity_ObjectToWorld, float4( v.vertex.xyz, 1 ) ).xyz;
				...
				float mulTime137_g3670 = _Time.y * ( WindOffsetSpeed / 10.0 );
				...
				float temp_output_2250_0 = ( smoothstepResult170_g3670 * _wind_amplitude116_g3670 );
				float wpo_wind_rawMask497_g2747 = temp_output_2250_0;
				float debug_disableWPO486_g2747 = DebugDisableWPO;
				#ifdef _DEBUGDISABLEWINDDPO_ON
				float staticSwitch479_g2747 = ( debug_disableWPO486_g2747 == 1.0 ? 0.0 : wpo_wind_rawMask497_g2747 );
				#else
				float staticSwitch479_g2747 = wpo_wind_rawMask497_g2747;
				#endif
				float wpo_wind_mask302_g2747 = staticSwitch479_g2747;
				float temp_output_25_0_g3646 = wpo_wind_mask302_g2747;
				...
				float3 temp_output_499_0_g2747 = ( wpo_CoordMask184_g2747 * ( ( rotatedValue17_g3646 + appendResult23_g3646 ) * _SimpleWindDisplacement * temp_output_25_0_g3646 ) );
				#ifdef _WIND_SIMPLE
				float3 staticSwitch425_g2747 = temp_output_499_0_g2747;
				#else
				float3 staticSwitch425_g2747 = float3( 0,0,0 );
				#endif
				float3 out_wpo_windy423_g2747 = staticSwitch425_g2747;
				float3 temp_output_159_0_g3654 = out_wpo_windy423_g2747;
				float4 transform584_g2747 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				float4 tex2DNode29_g3654 = tex2Dlod( CrushRenderTexture, float4( ( ( ( (transform584_g2747).xz + -CrushBufferOffset ) + ( CrushBufferSize / 2.0 ) ) / CrushBufferSize ), 0, 0.0) );
				...
				float3 worldToObjDir101_g3654 = mul( unity_WorldToObject, float4( appendResult102_g3654, 0 ) ).xyz;
				...
				float3 worldToObj14_g3654 = mul( unity_WorldToObject, float4( ase_worldPos, 1 ) ).xyz;
				...
				float crush_coordMasd87_g3654 = wpo_CoordMask184_g2747;
				float3 ase_parentObjectScale = ( 1.0 / float3( length( unity_WorldToObject[ 0 ].xyz ), length( unity_WorldToObject[ 1 ].xyz ), length( unity_WorldToObject[ 2 ].xyz ) ) );
				float RT_b236_g3654 = tex2DNode29_g3654.b;
				float4 transform223_g3654 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				...
				#endif
				float3 out_wpo_crush432_g2747 = staticSwitch162_g3654;
				float smoothstepResult112_g3647 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g2747);
				...
				float3 temp_output_88_0_g3647 = wpo_wind_direction306_g2747;
				float3 temp_output_544_0_g2747 = ( out_wpo_crush432_g2747 + ( temp_output_153_0_g3647 * temp_output_99_0_g3647 * temp_output_88_0_g3647 ) );
				#ifdef _WIND_SIMPLE
				float3 staticSwitch440_g2747 = temp_output_544_0_g2747;
				#else
				float3 staticSwitch440_g2747 = float3( 0,0,0 );
				#endif
				float3 wpo_out_turbulence508_g2747 = staticSwitch440_g2747;
				#ifdef _DEBUGDISABLEWINDDPO_ON
				float3 staticSwitch466_g2747 = ( debug_disableWPO486_g2747 == 1.0 ? out_wpo_crush432_g2747 : wpo_out_turbulence508_g2747 );
				#else
				float3 staticSwitch466_g2747 = wpo_out_turbulence508_g2747;
				#endif
				
				float3 lerpResult3_g2558 = lerp( v.normal , float3(0,1,0) , _FlattenVertexNormal);
				...
				) : SV_Target
			{
				...
				float3 objToWorld183_g3670 = mul( unity_ObjectToWorld, float4( IN.ase_texcoord10.xyz, 1 ) ).xyz;
				float3 break153_g3670 = -objToWorld183_g3670;
				float2 appendResult155_g3670 = (float2(break153_g3670.x , break153_g3670.z));
				float2 _wind_UVs106_g3670 = appendResult155_g3670;
				float mulTime137_g3670 = _Time.y * ( WindOffsetSpeed / 10.0 );
				...
				float4 transform584_g2747 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				float4 tex2DNode29_g3654 = tex2D( CrushRenderTexture, ( ( ( (transform584_g2747).xz + -CrushBufferOffset ) + ( CrushBufferSize / 2.0 ) ) / CrushBufferSize ) );
				float RT_b236_g3654 = tex2DNode29_g3654.b;
				float2 temp_output_96_0_g3654 = ( ( (tex2DNode29_g3654).rg - float2( 0.5,0.5 ) ) * float2( 2,2 ) );
				float vectorField_length134_g3654 = length( temp_output_96_0_g3654 );
				...
				float smoothstepResult112_g3647 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g2747);
				float temp_output_153_0_g3647 = saturate( smoothstepResult112_g3647 );
				float temp_output_544_85_g2747 = ( temp_output_99_0_g3647 * temp_output_153_0_g3647 );
				#ifdef _WIND_SIMPLE
				float staticSwitch442_g2747 = temp_output_544_85_g2747;
				#else
				float staticSwitch442_g2747 = 0.0;
				#endif
				float4 lerpResult62_g3669 = lerp( ifLocalVar131_g3669 , color64_g3669 , ( (float)debugWindTurbulence103_g3669 == 1.0 ? saturate( ( staticSwitch442_g2747 * 20.0 ) ) : 0.0 ));
				#ifdef _DEBUGWIND_ON
		...
		Pass
		{
			...
			)
			{
				...
				#endif
				float4 temp_output_23_0_g3665 = staticSwitch128_g3662;
				float3 objToWorld183_g3670 = mul( unity_ObjectToWorld, float4( IN.ase_texcoord9.xyz, 1 ) ).xyz;
				float3 break153_g3670 = -objToWorld183_g3670;
				float2 appendResult155_g3670 = (float2(break153_g3670.x , break153_g3670.z));
				float2 _wind_UVs106_g3670 = appendResult155_g3670;
				float mulTime137_g3670 = _Time.y * ( WindOffsetSpeed / 10.0 );
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				#endif
				float4 temp_output_23_0_g3665 = staticSwitch128_g3662;
				float3 objToWorld183_g3670 = mul( unity_ObjectToWorld, float4( IN.ase_texcoord5.xyz, 1 ) ).xyz;
				float3 break153_g3670 = -objToWorld183_g3670;
				float2 appendResult155_g3670 = (float2(break153_g3670.x , break153_g3670.z));
				float2 _wind_UVs106_g3670 = appendResult155_g3670;
				float mulTime137_g3670 = _Time.y * ( WindOffsetSpeed / 10.0 );
				...
				float mulTime95_g3647 = _Time.y * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float temp_output_99_0_g3647 = ( cos( ( ( ( ( ( transform119_g3647.x * 100.0 ) + ( transform119_g3647.z * 33.0 ) ) - mulTime95_g3647 ) + IN.ase_texcoord5.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * IN.ase_texcoord3.xy.y );
				float wpo_wind_rawMask497_g2747 = temp_output_2250_0;
				float smoothstepResult112_g3647 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g2747);
				float temp_output_153_0_g3647 = saturate( smoothstepResult112_g3647 );
				float temp_output_544_85_g2747 = ( temp_output_99_0_g3647 * temp_output_153_0_g3647 );
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				#endif
				float4 temp_output_23_0_g3665 = staticSwitch128_g3662;
				float3 objToWorld183_g3670 = mul( unity_ObjectToWorld, float4( IN.ase_texcoord4.xyz, 1 ) ).xyz;
				float3 break153_g3670 = -objToWorld183_g3670;
				float2 appendResult155_g3670 = (float2(break153_g3670.x , break153_g3670.z));
				float2 _wind_UVs106_g3670 = appendResult155_g3670;
				float mulTime137_g3670 = _Time.y * ( WindOffsetSpeed / 10.0 );
...
ASEEND*/
//CHKSM=9F65E2EA67B826B4BC0C78CB0A02057BA0FD9651