...
Shader "Eole/Built-In/Foliage Tesselated"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
			...
			v2f VertexFunction (appdata v  ) {
				...
				float2 temp_output_331_0_g3673 = (half3(0,0,1)).xz;
				float3 worldToObjDir141_g3671 = normalize( mul( unity_WorldToObject, float4( WindDirection, 0 ) ).xyz );
				float3 wpo_wind_direction306_g3672 = worldToObjDir141_g3671;
				float3 temp_output_295_0_g3673 = wpo_wind_direction306_g3672;
				float dotResult330_g3673 = dot( temp_output_331_0_g3673 , (temp_output_295_0_g3673).xz );
				float3 break444_g3673 = temp_output_295_0_g3673;
				float2 appendResult355_g3673 = (float2(break444_g3673.z , break444_g3673.x));
				float dotResult356_g3673 = dot( temp_output_331_0_g3673 , appendResult355_g3673 );
				float3 objToWorld183_g3671 = mul( unity_ObjectToWorld, float4( v.vertex.xyz, 1 ) ).xyz;
				float3 break153_g3671 = -objToWorld183_g3671;
				float2 appendResult155_g3671 = (float2(break153_g3671.x , break153_g3671.z));
				float2 _wind_UVs106_g3671 = appendResult155_g3671;
				float mulTime137_g3671 = _Time.y * ( WindOffsetSpeed / 10.0 );
				float3 break187_g3671 = WindDirection;
				float2 appendResult188_g3671 = (float2(break187_g3671.x , break187_g3671.z));
				float2 _wind_direction110_g3671 = appendResult188_g3671;
				float4 tex2DNode144_g3671 = tex2Dlod( WindMap, float4( ( ( _wind_UVs106_g3671 / WindTillingSize ) + ( mulTime137_g3671 * _wind_direction110_g3671 ) ), 0, 0.0) );
				float smoothstepResult53_g3671 = smoothstep( WindSmoothstep.x , WindSmoothstep.y , tex2DNode144_g3671.r);
				float smoothstepResult170_g3671 = smoothstep( _SecondWindSmoothstep.x , _SecondWindSmoothstep.y , smoothstepResult53_g3671);
				float _wind_amplitude116_g3671 = WindAmplitude;
				float temp_output_2375_0 = ( smoothstepResult170_g3671 * _wind_amplitude116_g3671 );
				float wpo_wind_rawMask497_g3672 = temp_output_2375_0;
				float debug_disableWPO486_g3672 = DebugDisableWPO;
				#ifdef _DEBUGDISABLEWINDDPO_ON
				float staticSwitch479_g3672 = ( debug_disableWPO486_g3672 == 1.0 ? 0.0 : wpo_wind_rawMask497_g3672 );
				#else
				float staticSwitch479_g3672 = wpo_wind_rawMask497_g3672;
				#endif
				float wpo_wind_mask302_g3672 = staticSwitch479_g3672;
				float wind_mask423_g3673 = wpo_wind_mask302_g3672;
				float lerpResult192_g3673 = lerp( 0.0 , ( acos( dotResult330_g3673 ) * sign( dotResult356_g3673 ) ) , wind_mask423_g3673);
				float3 appendResult465_g3673 = (float3(0.0 , _BezierP1.y , _BezierP1.x));
				float3 temp_output_453_0_g3673 = ( appendResult465_g3673 * _BezierAlpha );
				float3 appendResult419_g3673 = (float3(0.0 , _BezierOffsetP1.y , _BezierOffsetP1.x));
				float3 rotatedValue187_g3673 = RotateAroundAxis( float3( 0,0,0 ), ( temp_output_453_0_g3673 + ( appendResult419_g3673 * wind_mask423_g3673 * _BezierOffsetAlpha ) ), float3( 0,1,0 ), lerpResult192_g3673 );
				float3 temp_output_15_0_g3674 = rotatedValue187_g3673;
				float3 p121_g3674 = temp_output_15_0_g3674;
				float3 appendResult463_g3673 = (float3(0.0 , _BezierP2.y , _BezierP2.x));
				float3 temp_output_454_0_g3673 = ( appendResult463_g3673 * _BezierAlpha );
				float3 appendResult420_g3673 = (float3(0.0 , _BezierOffsetP2.y , _BezierOffsetP2.x));
				float3 rotatedValue195_g3673 = RotateAroundAxis( float3( 0,0,0 ), ( temp_output_454_0_g3673 + ( appendResult420_g3673 * wind_mask423_g3673 * _BezierOffsetAlpha ) ), float3( 0,1,0 ), lerpResult192_g3673 );
				float3 temp_output_14_0_g3674 = rotatedValue195_g3673;
				float3 p221_g3674 = temp_output_14_0_g3674;
				float wpo_CoordMask184_g3672 = v.ase_color.r;
				float temp_output_6_0_g3674 = wpo_CoordMask184_g3672;
				float t21_g3674 = temp_output_6_0_g3674;
				float3 localTrigonometricBezierCurve21_g3674 = TrigonometricBezierCurve( p121_g3674 , p221_g3674 , t21_g3674 );
				float3 temp_output_500_0_g3672 = localTrigonometricBezierCurve21_g3674;
				half3 _RelativeUp = half3(0,1,0);
				float3 temp_output_26_0_g3675 = wpo_wind_direction306_g3672;
				float dotResult7_g3675 = dot( temp_output_26_0_g3675 , _RelativeUp );
				float lerpResult10_g3675 = lerp( -1.570796 , 1.570796 , ( ( dotResult7_g3675 * 0.5 ) + 0.5 ));
				float3 rotatedValue17_g3675 = RotateAroundAxis( float3( 0,0,0 ), temp_output_26_0_g3675, normalize( cross( _RelativeUp , temp_output_26_0_g3675 ) ), lerpResult10_g3675 );
				float temp_output_25_0_g3675 = wpo_wind_mask302_g3672;
				float lerpResult21_g3675 = lerp( 0.0 , _SimpleWindyYOffset , temp_output_25_0_g3675);
				float3 appendResult23_g3675 = (float3(0.0 , lerpResult21_g3675 , 0.0));
				float3 temp_output_499_0_g3672 = ( wpo_CoordMask184_g3672 * ( ( rotatedValue17_g3675 + appendResult23_g3675 ) * _SimpleWindDisplacement * temp_output_25_0_g3675 ) );
				#if defined(_WIND_NONE)
				float3 staticSwitch166_g3672 = float3( 0,0,0 );
				#elif defined(_WIND_SIMPLE)
				float3 staticSwitch166_g3672 = temp_output_499_0_g3672;
				#elif defined(_WIND_ADVANCED)
				float3 staticSwitch166_g3672 = temp_output_500_0_g3672;
				#else
				float3 staticSwitch166_g3672 = temp_output_500_0_g3672;
				#endif
				float3 out_wpo_windy423_g3672 = staticSwitch166_g3672;
				float3 temp_output_159_0_g3679 = out_wpo_windy423_g3672;
				float4 transform584_g3672 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				float4 tex2DNode29_g3679 = tex2Dlod( CrushRenderTexture, float4( ( ( ( (transform584_g3672).xz + -CrushBufferOffset ) + ( CrushBufferSize / 2.0 ) ) / CrushBufferSize ), 0, 0.0) );
				float2 temp_output_96_0_g3679 = ( ( (tex2DNode29_g3679).rg - float2( 0.5,0.5 ) ) * float2( 2,2 ) );
				float2 break98_g3679 = temp_output_96_0_g3679;
				float3 appendResult102_g3679 = (float3(break98_g3679.x , 0.0 , break98_g3679.y));
				float3 worldToObjDir101_g3679 = mul( unity_WorldToObject, float4( appendResult102_g3679, 0 ) ).xyz;
				float3 crush_direction172_g3679 = worldToObjDir101_g3679;
				float vectorField_length134_g3679 = length( temp_output_96_0_g3679 );
				float3 temp_output_126_0_g3679 = float3( 0,0,0 );
				float3 ase_worldPos = mul(unity_ObjectToWorld, float4( (v.vertex).xyz, 1 )).xyz;
				float3 worldToObj14_g3679 = mul( unity_WorldToObject, float4( ase_worldPos, 1 ) ).xyz;
				float3 rotatedValue16_g3679 = RotateAroundAxis( temp_output_126_0_g3679, worldToObj14_g3679, crush_direction172_g3679, ( radians( _CrushAngle ) * vectorField_length134_g3679 ) );
				float3 appendResult195_g3679 = (float3(1.0 , ( 1.0 - _CrushFlattenScale ) , 1.0));
				float3 appendResult66_g3679 = (float3(0.0 , _CrushHeightOffset , 0.0));
				float crush_coordMasd87_g3679 = wpo_CoordMask184_g3672;
				float3 ase_parentObjectScale = ( 1.0 / float3( length( unity_WorldToObject[ 0 ].xyz ), length( unity_WorldToObject[ 1 ].xyz ), length( unity_WorldToObject[ 2 ].xyz ) ) );
				float RT_b236_g3679 = tex2DNode29_g3679.b;
				float4 transform223_g3679 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				float temp_output_235_0_g3679 = ( RT_b236_g3679 == 0.0 ? ( ( vectorField_length134_g3679 * saturate( ( crush_coordMasd87_g3679 * 8.0 ) ) ) * saturate( ( ( CrushDistanceView - distance( float4( _WorldSpaceCameraPos , 0.0 ) , transform223_g3679 ) ) / CrushDistanceViewFalloff ) ) ) : 0.0 );
				float3 lerpResult160_g3679 = lerp( temp_output_159_0_g3679 , ( ( ( rotatedValue16_g3679 - worldToObj14_g3679 ) * appendResult195_g3679 ) + ( appendResult66_g3679 * crush_coordMasd87_g3679 * ase_parentObjectScale.y ) ) , temp_output_235_0_g3679);
				#ifdef _USECRUSH_ON
				float3 staticSwitch162_g3679 = lerpResult160_g3679;
				#else
				float3 staticSwitch162_g3679 = temp_output_159_0_g3679;
				#endif
				float3 out_wpo_crush432_g3672 = staticSwitch162_g3679;
				float smoothstepResult112_g3676 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g3672);
				float temp_output_153_0_g3676 = saturate( smoothstepResult112_g3676 );
				float4 transform119_g3676 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				float mulTime95_g3676 = _Time.y * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float temp_output_99_0_g3676 = ( cos( ( ( ( ( ( transform119_g3676.x * 100.0 ) + ( transform119_g3676.z * 33.0 ) ) - mulTime95_g3676 ) + v.vertex.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * v.ase_texcoord.y );
				float3 temp_output_88_0_g3676 = wpo_wind_direction306_g3672;
				float3 temp_output_544_0_g3672 = ( out_wpo_crush432_g3672 + ( temp_output_153_0_g3676 * temp_output_99_0_g3676 * temp_output_88_0_g3676 ) );
				#if defined(_WIND_NONE)
				float3 staticSwitch438_g3672 = float3( 0,0,0 );
				#elif defined(_WIND_SIMPLE)
				float3 staticSwitch438_g3672 = temp_output_544_0_g3672;
				#elif defined(_WIND_ADVANCED)
				float3 staticSwitch438_g3672 = temp_output_544_0_g3672;
				#else
				float3 staticSwitch438_g3672 = temp_output_544_0_g3672;
				#endif
				float3 wpo_out_turbulence508_g3672 = staticSwitch438_g3672;
				#ifdef _DEBUGDISABLEWINDDPO_ON
				float3 staticSwitch466_g3672 = ( debug_disableWPO486_g3672 == 1.0 ? out_wpo_crush432_g3672 : wpo_out_turbulence508_g3672 );
				#else
				float3 staticSwitch466_g3672 = wpo_out_turbulence508_g3672;
				#endif
				
				float3 lerpResult3_g3670 = lerp( v.normal , float3(0,1,0) , _FlattenVertexNormal);
				...
				#endif
				float3 vertexValue = staticSwitch466_g3672;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
				...
				) : SV_Target
			{
				...
				float3 objToWorld183_g3671 = mul( unity_ObjectToWorld, float4( IN.ase_texcoord10.xyz, 1 ) ).xyz;
				float3 break153_g3671 = -objToWorld183_g3671;
				float2 appendResult155_g3671 = (float2(break153_g3671.x , break153_g3671.z));
				float2 _wind_UVs106_g3671 = appendResult155_g3671;
				float mulTime137_g3671 = _Time.y * ( WindOffsetSpeed / 10.0 );
				...
				float2 appendResult188_g3671 = (float2(break187_g3671.x , break187_g3671.z));
				float2 _wind_direction110_g3671 = appendResult188_g3671;
				float4 tex2DNode144_g3671 = tex2D( WindMap, ( ( _wind_UVs106_g3671 / WindTillingSize ) + ( mulTime137_g3671 * _wind_direction110_g3671 ) ) );
				float smoothstepResult53_g3671 = smoothstep( WindSmoothstep.x , WindSmoothstep.y , tex2DNode144_g3671.r);
				float smoothstepResult170_g3671 = smoothstep( _SecondWindSmoothstep.x , _SecondWindSmoothstep.y , smoothstepResult53_g3671);
				float _wind_amplitude116_g3671 = WindAmplitude;
				float temp_output_2375_0 = ( smoothstepResult170_g3671 * _wind_amplitude116_g3671 );
				float windMask397_g3660 = temp_output_2375_0;
				float lerpResult71_g3665 = lerp( 1.0 , _WindBrightness , windMask397_g3660);
				float4 transform584_g3672 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				float4 tex2DNode29_g3679 = tex2D( CrushRenderTexture, ( ( ( (transform584_g3672).xz + -CrushBufferOffset ) + ( CrushBufferSize / 2.0 ) ) / CrushBufferSize ) );
				float RT_b236_g3679 = tex2DNode29_g3679.b;
				float2 temp_output_96_0_g3679 = ( ( (tex2DNode29_g3679).rg - float2( 0.5,0.5 ) ) * float2( 2,2 ) );
				float vectorField_length134_g3679 = length( temp_output_96_0_g3679 );
				float wpo_CoordMask184_g3672 = IN.ase_color.r;
				float crush_coordMasd87_g3679 = wpo_CoordMask184_g3672;
				float4 transform223_g3679 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				float temp_output_235_0_g3679 = ( RT_b236_g3679 == 0.0 ? ( ( vectorField_length134_g3679 * saturate( ( crush_coordMasd87_g3679 * 8.0 ) ) ) * saturate( ( ( CrushDistanceView - distance( float4( _WorldSpaceCameraPos , 0.0 ) , transform223_g3679 ) ) / CrushDistanceViewFalloff ) ) ) : 0.0 );
				#ifdef _USECRUSH_ON
				float staticSwitch163_g3679 = temp_output_235_0_g3679;
				#else
				float staticSwitch163_g3679 = 0.0;
				#endif
				float lerpResult78_g3665 = lerp( lerpResult71_g3665 , _CrushBrightness , staticSwitch163_g3679);
				...
				float3 normalizeResult19_g3668 = normalize( ( _WorldSpaceCameraPos - worldPos ) );
				float3 worldSpaceLightDir = UnityWorldSpaceLightDir(worldPos);
				float dotResult20_g3668 = dot( normalizeResult19_g3668 , -worldSpaceLightDir );
				float saferPower25_g3668 = abs( ( ( dotResult20_g3668 + 1.0 ) / 2.0 ) );
				float lerpResult3_g3668 = lerp( _TranslucencyShadows , _TranslucencyDirect , float4(atten,0,0,0));
				...
				float mulTime95_g3676 = _Time.y * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float temp_output_99_0_g3676 = ( cos( ( ( ( ( ( transform119_g3676.x * 100.0 ) + ( transform119_g3676.z * 33.0 ) ) - mulTime95_g3676 ) + IN.ase_texcoord10.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * IN.ase_texcoord9.xy.y );
				float wpo_wind_rawMask497_g3672 = temp_output_2375_0;
				float smoothstepResult112_g3676 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g3672);
				float temp_output_153_0_g3676 = saturate( smoothstepResult112_g3676 );
				float temp_output_544_85_g3672 = ( temp_output_99_0_g3676 * temp_output_153_0_g3676 );
				#if defined(_WIND_NONE)
				float staticSwitch441_g3672 = 0.0;
				#elif defined(_WIND_SIMPLE)
				float staticSwitch441_g3672 = temp_output_544_85_g3672;
				#elif defined(_WIND_ADVANCED)
				float staticSwitch441_g3672 = temp_output_544_85_g3672;
				#else
				float staticSwitch441_g3672 = temp_output_544_85_g3672;
				#endif
				float4 lerpResult62_g3669 = lerp( ifLocalVar131_g3669 , color64_g3669 , ( (float)debugWindTurbulence103_g3669 == 1.0 ? saturate( ( staticSwitch441_g3672 * 20.0 ) ) : 0.0 ));
				#ifdef _DEBUGWIND_ON
		...
		Pass
		{
			...
			)
			{
				...
				#endif
				float4 temp_output_23_0_g3665 = staticSwitch128_g3662;
				float3 objToWorld183_g3671 = mul( unity_ObjectToWorld, float4( IN.ase_texcoord9.xyz, 1 ) ).xyz;
				float3 break153_g3671 = -objToWorld183_g3671;
				float2 appendResult155_g3671 = (float2(break153_g3671.x , break153_g3671.z));
				float2 _wind_UVs106_g3671 = appendResult155_g3671;
				float mulTime137_g3671 = _Time.y * ( WindOffsetSpeed / 10.0 );
				...
				float mulTime95_g3676 = _Time.y * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float temp_output_99_0_g3676 = ( cos( ( ( ( ( ( transform119_g3676.x * 100.0 ) + ( transform119_g3676.z * 33.0 ) ) - mulTime95_g3676 ) + IN.ase_texcoord9.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * IN.ase_texcoord8.xy.y );
				float wpo_wind_rawMask497_g3672 = temp_output_2375_0;
				float smoothstepResult112_g3676 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g3672);
				float temp_output_153_0_g3676 = saturate( smoothstepResult112_g3676 );
				float temp_output_544_85_g3672 = ( temp_output_99_0_g3676 * temp_output_153_0_g3676 );
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				#endif
				float4 temp_output_23_0_g3665 = staticSwitch128_g3662;
				float3 objToWorld183_g3671 = mul( unity_ObjectToWorld, float4( IN.ase_texcoord5.xyz, 1 ) ).xyz;
				float3 break153_g3671 = -objToWorld183_g3671;
				float2 appendResult155_g3671 = (float2(break153_g3671.x , break153_g3671.z));
				float2 _wind_UVs106_g3671 = appendResult155_g3671;
				float mulTime137_g3671 = _Time.y * ( WindOffsetSpeed / 10.0 );
				...
				float3 blendOpSrc15_g3668 = temp_cast_3;
				float3 blendOpDest15_g3668 = (_translucency_inColor32_g3668).rgb;
				float3 normalizeResult19_g3668 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
				float3 worldSpaceLightDir = UnityWorldSpaceLightDir(ase_worldPos);
				float dotResult20_g3668 = dot( normalizeResult19_g3668 , -worldSpaceLightDir );
				float saferPower25_g3668 = abs( ( ( dotResult20_g3668 + 1.0 ) / 2.0 ) );
				UNITY_LIGHT_ATTENUATION(ase_atten, IN, ase_worldPos)
				float lerpResult3_g3668 = lerp( _TranslucencyShadows , _TranslucencyDirect , ase_atten);
				float3 lerpBlendMode15_g3668 = lerp(blendOpDest15_g3668,2.0f*blendOpDest15_g3668*blendOpSrc15_g3668 + blendOpDest15_g3668*blendOpDest15_g3668*(1.0f - 2.0f*blendOpSrc15_g3668),( saturate( pow( saferPower25_g3668 , _TranslucencyDotViewPower ) ) * lerpResult3_g3668 ));
				float4 appendResult30_g3668 = (float4(( saturate( lerpBlendMode15_g3668 )) , (_translucency_inColor32_g3668).a));
				#ifdef _USETRANSLUCENCY_ON
				float4 staticSwitch31_g3668 = appendResult30_g3668;
				...
				float mulTime95_g3676 = _Time.y * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float temp_output_99_0_g3676 = ( cos( ( ( ( ( ( transform119_g3676.x * 100.0 ) + ( transform119_g3676.z * 33.0 ) ) - mulTime95_g3676 ) + IN.ase_texcoord5.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * IN.ase_texcoord3.xy.y );
				float wpo_wind_rawMask497_g3672 = temp_output_2375_0;
				float smoothstepResult112_g3676 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g3672);
				float temp_output_153_0_g3676 = saturate( smoothstepResult112_g3676 );
				float temp_output_544_85_g3672 = ( temp_output_99_0_g3676 * temp_output_153_0_g3676 );
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				#endif
				float4 temp_output_23_0_g3665 = staticSwitch128_g3662;
				float3 objToWorld183_g3671 = mul( unity_ObjectToWorld, float4( IN.ase_texcoord4.xyz, 1 ) ).xyz;
				float3 break153_g3671 = -objToWorld183_g3671;
				float2 appendResult155_g3671 = (float2(break153_g3671.x , break153_g3671.z));
				float2 _wind_UVs106_g3671 = appendResult155_g3671;
				float mulTime137_g3671 = _Time.y * ( WindOffsetSpeed / 10.0 );
...
WireConnection;2428;0;2423;0
WireConnection;2428;1;2423;70
WireConnection;2428;5;2423;251
WireConnection;2428;7;2423;1
WireConnection;2428;8;2423;273
WireConnection;2428;15;2410;0
WireConnection;2428;16;2426;0
WireConnection;2410;421;2375;0
WireConnection;2410;422;2375;24
ASEEND*/
//CHKSM=E29BC7C84645A9C337A35DB6AECB13B9E5A077E4